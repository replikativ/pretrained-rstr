(ns build
  "Build tasks for pretrained-rstr.

  Usage:
    clj -T:build clean
    clj -T:build jar
    clj -T:build deploy      ;; needs CLOJARS_USERNAME / CLOJARS_PASSWORD
    clj -T:build release     ;; GitHub release artifact
    clj -T:build install"
...
(def org "replikativ")
(def lib 'org.replikativ/pretrained-rstr)
