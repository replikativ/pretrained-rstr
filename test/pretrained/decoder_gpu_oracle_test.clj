...
(raster.core/deftm gemma-layer-oracle!
  ...
  (do
    ...
    (qk/quant-act-q8k-rows-gpu! h qinp qins qinb submax 768 1)
    ...
    (qk/quant-act-q8k-rows-gpu! at qap qas qab submax 1024 1)
    ...
    (qk/quant-act-q8k-rows-gpu! f qfp qfs qfb submax 768 1)
    ...
    (qk/quant-act-q8k-rows-gpu! hh qhp qhs qhb submax 2048 1)
...
(raster.core/deftm gemma-head-oracle!
  ...
  (do
    ...
    (qk/quant-act-q8k-rows-gpu! fh hqp hqs hqb submax 768 1)
